...
{
    public partial class Busqueda_de_Gastos_de_Inventario : Form
    {
        public Busqueda_de_Gastos_de_Inventario()
        {
            InitializeComponent();
        }
        #region Diseño
        ...
        private void Diseño_Ventana()
        {
            ...
            this.Name = "Busqueda_de_Gastos_de_Inventario";
            this.Text = "Historial de gastos de inventarios";
            ...
            this.Load += new System.EventHandler(this.Busqueda_de_Gastos_de_Inventario_Load);
        ...
        #endregion
        private void Busqueda_de_Gastos_de_Inventario_Load(object sender, EventArgs e)
        {
            #region Animacion
        ...
        private void bttn_Consultar_Click(object sender, EventArgs e)
        {
            ...
            Reporte_de_Gastos_de_Inversión rc = new Reporte_de_Gastos_de_Inversión();
