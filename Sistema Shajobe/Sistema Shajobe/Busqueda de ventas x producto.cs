...
{
    public partial class Busqueda_de_ventas_x_producto : Form
    {
        public Busqueda_de_ventas_x_producto()
        {
            InitializeComponent();
        }
        #region Diseño
        ...
        private void Diseño_Ventana()
        {
            ...
            this.Name = "Busqueda_de_ventas_x_producto";
            this.Text = "Busqueda de venta por producto";
            ...
            this.Load += new System.EventHandler(this.Busqueda_de_ventas_x_producto_Load);
        ...
        #endregion
        private void Busqueda_de_ventas_x_producto_Load(object sender, EventArgs e)
        {
            #region Animacion
