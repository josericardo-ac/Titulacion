...
{
    public partial class Tipo_pieza : Form
    {
        public Tipo_pieza()
        {
            InitializeComponent();
        ...
        #endregion
        private void Tipo_pieza_Load(object sender, EventArgs e)
        {
            #region Animacion
        ...
        public void BusquedaDatos(int Idp)
        {
            ...
            coman.CommandText = "Select * from Tb_TipoPieza where Id_TipoPieza='" + Idp + "'";
        ...
        private void guardarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    OleDbCommand comando = new OleDbCommand("SP_TipoPieza_Alta", conexion, transaccion);
        ...
        private void modificarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    OleDbCommand comando = new OleDbCommand("SP_TipoPieza_Cambios", con, tran);
                    comando.CommandType = CommandType.StoredProcedure;
                    comando.Parameters.Clear();
        ...
        private void abrirToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            lbl_Etiqueta.Text = "Escriba el nombre ó Lote del tipo de pieza a buscar";
            // 
            // bttn_Busqueda
            // 
        ...
        public static DataTable Datos()
        {
            ...
            string consulta = "select * from V_TiposPiezas"; //consulta a la tabla Tipos de piezas
        ...
        //-------------------------------------------------------------
        private void Tipo_PiezaFormClosing(object sender, FormClosingEventArgs e)
        {
            Dispose();
            Application.OpenForms["Menu_principal"].Activate();
        }
