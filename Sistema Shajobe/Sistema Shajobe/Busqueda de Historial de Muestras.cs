...
{
    public partial class Busqueda_de_Historial_de_Muestras : Form
    {
        public Busqueda_de_Historial_de_Muestras()
        {
            InitializeComponent();
        }
        #region Diseño
        ...
        private void Diseño_Ventana()
        {
            ...
            this.Name = "Busqueda_de_Historial_de_Muestras";
            this.Text = "Historial de Muestras";
            ...
            this.Load += new System.EventHandler(this.Busqueda_de_Historial_de_Muestras_Load);
        ...
        #endregion
        private void Busqueda_de_Historial_de_Muestras_Load(object sender, EventArgs e)
        {
            #region Animacion
