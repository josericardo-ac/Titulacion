...
{
    public partial class Reporte_de_Historial_de_pedidos : Form
    {
        public Reporte_de_Historial_de_pedidos()
        {
            InitializeComponent();
        }
        ...
        private void Reporte_de_Historial_de_pedidos_FormClosing(object sender, FormClosingEventArgs e)
        {
            //-------------------------------------------------------------
