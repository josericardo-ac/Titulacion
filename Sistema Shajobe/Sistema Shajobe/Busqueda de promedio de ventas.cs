...
{
    public partial class Busqueda_de_promedio_de_ventas : Form
    {
        public Busqueda_de_promedio_de_ventas()
        {
            InitializeComponent();
        }
        #region Diseño
        ...
        private void Diseño_Ventana()
        {
            ...
            this.Name = "Busqueda_de_promedio_de_ventas";
            ...
            this.Load += new System.EventHandler(this.Busqueda_de_promedio_de_ventas_Load);
        ...
        #endregion
        private void Busqueda_de_promedio_de_ventas_Load(object sender, EventArgs e)
        {
            #region Animacion
        ...
        private void bttn_Consultar_Click(object sender, EventArgs e)
        {
            ...
            Reporte_Ventas rc = new Reporte_Ventas();
