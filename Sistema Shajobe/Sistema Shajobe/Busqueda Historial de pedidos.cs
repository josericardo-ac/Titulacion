...
{
    public partial class Busqueda_Historial_de_pedidos : Form
    {
        public Busqueda_Historial_de_pedidos()
        {
            InitializeComponent();
        }
        #region Diseño
        ...
        #endregion
        private void Busqueda_Historial_de_pedidos_Load(object sender, EventArgs e)
        {
            #region Animacion
        ...
        private void bttn_Consultar_Click(object sender, EventArgs e)
        {
            ...
            Reporte_de_Historial_de_pedidos rc = new Reporte_de_Historial_de_pedidos();
