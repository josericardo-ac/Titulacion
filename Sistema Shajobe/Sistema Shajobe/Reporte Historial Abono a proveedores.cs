...
{
    public partial class Reporte_Historial_Abono_a_proveedores : Form
    {
        public Reporte_Historial_Abono_a_proveedores()
        {
            InitializeComponent();
        }
        ...
        private void Reporte_Historial_Abono_a_proveedores_FormClosing(object sender, FormClosingEventArgs e)
        {
            //-------------------------------------------------------------
        ...
        private void Reporte_Historial_Abono_a_proveedores_Load(object sender, EventArgs e)
        {
            ...
            crystalReportViewer1.ReportSource = RHistorialAbonoProveedores1;
        }
    }
}
