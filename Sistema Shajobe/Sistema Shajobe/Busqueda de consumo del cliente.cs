...
{
    public partial class Busqueda_de_consumo_del_cliente : Form
    {
        public Busqueda_de_consumo_del_cliente()
        {
            InitializeComponent();
        }
        #region Diseño
        ...
        private void Diseño_Ventana()
        {
            ...
            this.Name = "Busqueda_de_consumo_del_cliente";
            this.Text = "Consumo del cliente";
            ...
            this.Load += new System.EventHandler(this.Busqueda_de_consumo_del_cliente_Load);
        ...
        #endregion
        private void Busqueda_de_consumo_del_cliente_Load(object sender, EventArgs e)
        {
            #region Animacion
