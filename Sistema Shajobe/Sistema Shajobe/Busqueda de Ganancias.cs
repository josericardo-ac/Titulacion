...
{
    public partial class Busqueda_de_Ganancias : Form
    {
        public Busqueda_de_Ganancias()
        {
            InitializeComponent();
        }
        #region Diseño
        ...
        private void Diseño_Ventana()
        {
            ...
            this.Name = "Busqueda_de_Ganancias";
            this.Text = "Historial de ganancias";
            ...
            this.Load += new System.EventHandler(this.Busqueda_de_Ganancias_Load);
        ...
        #endregion
        private void Busqueda_de_Ganancias_Load(object sender, EventArgs e)
        {
            #region Animacion
        ...
        private void bttn_Consultar_Click(object sender, EventArgs e)
        {
            ...
            Reporte_Ganancias rc = new Reporte_Ganancias();
