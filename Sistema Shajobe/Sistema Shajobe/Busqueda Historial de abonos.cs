...
{
    public partial class Busqueda_Historial_de_abonos : Form
    {
        public Busqueda_Historial_de_abonos()
        {
            InitializeComponent();
        }
        #region Diseño
        ...
        private void Diseño_Ventana()
        {
            ...
            this.Text = "Busquesda de Historial de abonos a clientes";
        ...
        #endregion
        private void Busqueda_Historial_de_abonos_Load(object sender, EventArgs e)
        {
            #region Animacion
        ...
        private void bttn_Consultar_Click(object sender, EventArgs e)
        {
            ...
            Reporte_historial_de_abonos_cliente rc = new Reporte_historial_de_abonos_cliente();
