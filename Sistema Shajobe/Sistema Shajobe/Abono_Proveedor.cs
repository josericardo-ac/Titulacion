...
{
    public partial class Abono_Proveedor : Form
    {
        public Abono_Proveedor()
        {
            InitializeComponent();
        }
        ...
        private void Diseña_Forma()
        {
            ...
            this.groupBox_DatosProveedor.Controls.Add(this.lbl_Proveedores);
            ...
            this.groupBox_DatosProveedor.TabIndex = 6;
            this.groupBox_DatosProveedor.TabStop = false;
            this.groupBox_DatosProveedor.Text = "Datos del cliente";
            this.groupBox_DatosProveedor.SendToBack();
            // 
            // btt_Buscar
            // 
            ...
            this.dataGridView_Proveedor.SendToBack();
            this.dataGridView_Proveedor.Click += new EventHandler(HistorialAbonos_Click);
            // 
            // Id_ProveedorC
            // 
            ...
            this.lbl_Proveedores.Location = new System.Drawing.Point(14, 28);
            this.lbl_Proveedores.Name = "lbl_Proveedores";
            this.lbl_Proveedores.Size = new System.Drawing.Size(44, 13);
            this.lbl_Proveedores.TabIndex = 9;
        ...
        #endregion
        private void Abono_Proveedor_Load(object sender, EventArgs e)
        {
            #region Animacion
        ...
        private void Busqueda_Proveedor()
        {
        ...
        public static DataTable Datos_Proveedor()
        {
            ...
            //string consulta = "SELECT * FROM Tb_Proveedor where Activo='S'"; 
            string consulta = "SELECT Nombre, Apellido_P, Apellido_M FROM Tb_Proveedor WHERE (Activo = 'S') AND (Saldo > 0)"; //SOLO SE TRAE Proveedores QUE TENGAN SALDO MAYOR >0
        ...
        private void HistorialAbonos_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                int HProveedor = Convert.ToInt32(dataGridView_Proveedor.CurrentRow.Cells["Id_ProveedorC"].Value);
                OleDbConnection con = new OleDbConnection();
                OleDbCommand coman = new OleDbCommand();
                OleDbDataReader dr;
                con.ConnectionString = ObtenerString();
                coman.Connection = con;
                coman.CommandText = "SELECT Saldo FROM Tb_Proveedor WHERE (Id_Proveedor = '" + HProveedor + "') AND (Activo = 'S')";
                coman.CommandType = CommandType.Text;
                con.Open();
            ...
            try
            {
                ...
                con.ConnectionString = ObtenerString();
                coman.Connection = con;
                coman.CommandText = "SELECT Tb_Abono_Proveedor.* FROM Tb_Abono_Proveedor WHERE (Id_Proveedor = '" + HProveedor + "') AND (Activo = 'S')";
                coman.CommandType = CommandType.Text;
                con.Open();
                dataGridView_HistorialAbonos.Rows.Clear();
                dr = coman.ExecuteReader();
                while (dr.Read())
                {
                    ...
                    dataGridView_HistorialAbonos.Rows[Renglon].Cells["Id_Abono"].Value = dr.GetInt32(dr.GetOrdinal("Id_AbonoProveedor"));
        ...
        private void Busqueda()
        {
            ...
            else
            {
                ...
                coman.CommandText = "Select Id_Proveedor,Nombre,Apellido_P,Apellido_M,Nombre_Contacto,RFC from Tb_Proveedor where (Nombre='" + busqueda.ToUpper() + "'OR Apellido_P='" + busqueda.ToUpper() + "'OR Apellido_M='" + busqueda.ToUpper() + "'OR Nombre_Contacto='" + busqueda.ToUpper() + "'OR RFC='" + busqueda.ToUpper() + "') AND Activo='S'";
                coman.CommandType = CommandType.Text;
                con.Open();
        ...
        private void guardarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    OleDbCommand comando = new OleDbCommand("SP_Abono_ProveedorAlta", conexion, transaccion);
                    comando.CommandType = CommandType.StoredProcedure;
                    comando.Parameters.Clear();
                    comando.Parameters.AddWithValue("@Id_Proveedor", Convert.ToInt32(dataGridView_Proveedor.CurrentRow.Cells["Id_ProveedorC"].Value));
        ...
        private void EliminarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (data_resultado.CurrentRow == null)
                MessageBox.Show("Seleccione un proveedor", "Error de selección", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            else
            {
                ...
                try
                {
                    ...
                    OleDbCommand comando = new OleDbCommand("SP_Abono_ProveedorBajas", con, tran);
                    comando.CommandType = CommandType.StoredProcedure;
                    comando.Parameters.Clear();
        ...
        private void abrirToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            lbl_Etiqueta.Text = "Escriba el nombre ó uno de los apellidos del proveedor a buscar";
            // 
            // bttn_Busqueda
            // 
        ...
        public static DataTable Datos()
        {
            DataTable dt = new DataTable();
            OleDbConnection conexion = new OleDbConnection(ObtenerString());//cadena conexion
            string consulta = "SELECT Nombre, Apellido_P, Apellido_M FROM Tb_Proveedor WHERE (Activo = 'S') AND (Saldo > 0)"; //consulta a la tabla paises
            OleDbCommand comando = new OleDbCommand(consulta, conexion);
            OleDbDataAdapter adap = new OleDbDataAdapter(comando);
            adap.Fill(dt);
            return dt;
