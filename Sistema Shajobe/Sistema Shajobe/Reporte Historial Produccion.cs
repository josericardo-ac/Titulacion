...
{
    public partial class Reporte_Historial_Produccion : Form
    {
        public Reporte_Historial_Produccion()
        {
            InitializeComponent();
        }
        ...
        private void Reporte_Historial_Produccion_Load(object sender, EventArgs e)
        {
            ...
            crystalReportViewer1.ReportSource = RHistorialProduccion1;
        }

        private void Reporte_Historial_Produccion_FormClosing(object sender, FormClosingEventArgs e)
        {
            //-------------------------------------------------------------
