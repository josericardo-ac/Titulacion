...
{
    public partial class Reporte_historial_de_abonos_cliente : Form
    {
        public Reporte_historial_de_abonos_cliente()
        {
            InitializeComponent();
        }
        ...
        private void Reporte_historial_de_abonos_cliente_Load(object sender, EventArgs e)
        {
            ...
            crystalReportViewer1.ReportSource = RHistorialAbonoCliente1;
        }

        private void Reporte_historial_de_abonos_cliente_FormClosing(object sender, FormClosingEventArgs e)
        {
            //-------------------------------------------------------------
            //-------------------AL CERRAR LA VENTANA----------------------
            //-------------------------------------------------------------
            Dispose();
            Application.OpenForms["Reporte_historial_de_abonos_cliente"].Activate();
        }
    }
}
