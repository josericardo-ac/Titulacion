...
{
    public partial class Busqueda_Historial_de_abonos_proveedores : Form
    {
        public Busqueda_Historial_de_abonos_proveedores()
        {
            InitializeComponent();
        }
        #region Diseño
        ...
        private void Diseño_Ventana()
        {
            ...
            this.Name = "Busqueda_Historial_de_abonos_proveedores";
            this.Text = "Historial de abonos a proveedores";
            ...
            this.Load += new System.EventHandler(this.Busqueda_Historial_de_abonos_proveedores_Load);
        ...
        #endregion
        private void Busqueda_Historial_de_abonos_proveedores_Load(object sender, EventArgs e)
        {
            #region Animacion
