...
{
    public partial class Busqueda_Historial_de_Produccion : Form
    {
        public Busqueda_Historial_de_Produccion()
        {
            InitializeComponent();
        }
        #region Diseño
        ...
        private void Diseño_Ventana()
        {
            ...
            this.Name = "Busqueda_Historial_de_Producción";
            ...
            this.Load += new System.EventHandler(this.Busqueda_Historial_de_Produccion_Load);
        ...
        #endregion
        private void Busqueda_Historial_de_Produccion_Load(object sender, EventArgs e)
        {
            #region Animacion
        ...
        private void bttn_Consultar_Click(object sender, EventArgs e)
        {
            ...
            Reporte_Historial_Produccion rc = new Reporte_Historial_Produccion();
